            ...
            if ( have_posts() ) { 
                ...
                while ( have_posts() ) { 
                    ...
                    <div class="article full flex row afc jfc">
                        ...
                        $today = date('Ymd');
                        $event_date = date('l, F jS, Y', strtotime(get_post_meta($aID, 'event_date', true)));
                        $event_end_date = get_post_meta($aID, 'event_end_date', true);
                        ...
                        echo $event_date.' ';
                        if($event_end_date){
                            echo ' - ' . date('l, F jS, Y', strtotime($event_end_date)) . ' ';
                        }
                        ...
                        foreach($cats as $cat) {
                            ...
                            echo '<a href="/event-type/'.$cat->slug.'">'.$cat->name.'</a>'.$comma;
                            if($cat->slug == 'webinars') $is_webinar = true;
                        }
