            ...
            if ( have_posts() ) { 
                ...
                ?>
                    <div class="article full flex row afc jfc">
                        ...
                        $featured_post = get_post_meta($aID, 'make_featured_post', true);
                        $featured_post = ($featured_post !=='0' && $featured_post !== '');
                        if($featured_post) {
                            $focus_image = get_the_post_thumbnail_url($aID, 'bc-large-thumbnail-size');
                        }else {
                        ...
                        if(!empty($focus_image)) {
                            if($featured_post) {
                                echo '<div class="full no_image featured nobreak flex col"><a href="'.$link.'"><img src="'.$focus_image.'" /></a>';
                            }else {
                                echo '<div class="item_1_5 nobreak flex"><a href="'.$link.'"><img src="'.$focus_image.'" /></a></div>';
                                echo '<div class="item_4_5 nobreak flex col">';
                            }
                        }else {
                            echo '<div class="full no_image nobreak flex col">';
                        }
